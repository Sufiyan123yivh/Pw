...
const config = {
  ...
  sn: "0EAB2E1567B7C",
  device_id_1:
    "70C23DD730254829746E5A44106FE1655181105E0E22C2D4FE74026C3F415F8B",
  device_id_2:
    "49C2A324A06A763AE42CB3EEF6DEF0CEF90178D913FEE5F92C86B5ABFD080DBB",
  sig: "41AA84678ABEFBCF8BC706F45F0FE396463B59C7776DAC128EC9C43D85490FA2",
  api: "263",
};
...
export default async function handler(req, res) {
  try {
    const baseUrl = `${req.headers["x-forwarded-proto"] || "https"}://${req.headers.host}/api/Tvzon`;
