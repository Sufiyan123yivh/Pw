...
const config = {
  ...
  device_id_2:
    "B991523267D1BB49805698E17398505CD9D6C8BB29BC17A4106F3901EB486C13",
  sig: "262CAB3A552AB90F27074C6B8F322F49F9C1DD56642B4CC2D07B14F5704DF30D",
  api: "263",
};
...
export default async function handler(req, res) {
  try {
    const baseUrl = `${req.headers["x-forwarded-proto"] || "https"}://${req.headers.host}/api/airtel4k.m3u8`;
